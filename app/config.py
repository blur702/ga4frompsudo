...
class Config:
    ...
    AUTH = {
        ...
        'scope': [
            ...
            'https://www.googleapis.com/auth/analytics'  # For potential future admin operations if needed
        ]
    }
...
class TestingConfig(Config):
    ...
    AUTH = {
        ...
        'redirect_uri': 'http://localhost.test/auth/callback',
        'token_uri': 'https://example.com/oauth/token',  # Mocked endpoint
        'auth_uri': 'https://example.com/oauth/auth',    # Mocked endpoint
