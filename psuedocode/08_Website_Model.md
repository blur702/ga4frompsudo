...
This file provides the pseudocode for the `Website` model. It represents a website or web data stream associated with a GA4 Property and inherits common functionalities from `BaseModel`.

**Target Application File:** `app/models/website.py`
**Corresponding Test File (to be generated by LLM):** `tests/unit/models/test_website.py` (The pseudocode for these tests is available in the original `testing-pseudocode.md` and should be adapted based on the refined `Website` model here.)

## Pseudocode for Application Code (`app/models/website.py`)
...
class Website(BaseModel):
    ...
    def __init__(self, database: 'Database',
                 ...
                 create_time: Optional[str | datetime.datetime] = None,
                 update_time: Optional[str | datetime.datetime] = None,
        ...
        Args:
            ...
            website_url (Optional[str]): The display URL of the website.
            create_time (Optional[str | datetime.datetime]): Website/Data Stream creation timestamp.
                                                               If str, should be ISO 8601 format.
            update_time (Optional[str | datetime.datetime]): Website/Data Stream last update timestamp.
                                                               If str, should be ISO 8601 format.
        ...
        self.create_time: Optional[datetime.datetime] = self._iso_to_datetime(create_time) if isinstance(create_time, str) else create_time
        self.update_time: Optional[datetime.datetime] = self._iso_to_datetime(update_time) if isinstance(update_time, str) else update_time
    ...
    def _from_db_row(cls, row_dict: dict, database_instance: 'Database') -> 'Website':
        ...
        return cls(
            ...
            create_time=row_dict.get('create_time'), # __init__ will parse
            update_time=row_dict.get('update_time')  # __init__ will parse
        )
